...
export function createInitialSjProjects(): SjProject[] {
  const checklist = [
    ...
    { label: '商业计划书/研究计划', ok: true },
    { label: '技术资料', ok: false },
    { label: '团队成员信息', ok: true },
    { label: '资源需求清单', ok: true },
  ]
  ...
  const p1: SjProject = {
    ...
    attachments: [
      ...
      { category: '资源需求清单', name: '资源需求清单.xlsx', sizeLabel: '0.5MB', uploadedAt: '2025-05-10' },
  ...
  const p3: SjProject = {
    ...
    aiReport: {
      ...
      pros: '临床转化路径清晰，医院资源协同强。',
      risks: '伦理批件需更新。',
      suggest: '建议实体入孵并尽快完成专家分配。',
    },
    aiEvaluatedAt: '2025-05-08 11:00',
    attachments: [
    ...
    checklist,
    timeline: sjBaseTimeline('pending_expert_assign', { aiScore: 84 }),
    experts: [],
  }
  ...
  const p5: SjProject = {
    ...
    attachments: [
      { category: '商业计划书', name: 'BP.pdf', sizeLabel: '2.1MB', uploadedAt: '2025-05-09' },
      { category: '主体资质证明', name: '营业执照.jpg', sizeLabel: '1.1MB', uploadedAt: '2025-05-09' },
      { category: '团队资料', name: '团队简历.pdf', sizeLabel: '0.9MB', uploadedAt: '2025-05-09' },
      { category: '资源需求清单', name: '资源需求.xlsx', sizeLabel: '0.4MB', uploadedAt: '2025-05-09' },
    ],
    checklist: [
      { label: '主体资质证明', ok: true },
      { label: '商业计划书/研究计划', ok: true },
